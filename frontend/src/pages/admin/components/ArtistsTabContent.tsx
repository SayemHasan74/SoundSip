...
const ArtistsTabContent = () => {
	...
	const handleDeleteArtist = async (id: string) => {
		if (!window.confirm("Are you sure you want to delete this artist? This will remove their artist status and verification badge.")) {
			return;
		}
	...
	return (
		<div className="bg-zinc-800/50 p-4 sm:p-6 rounded-lg">
			...
			{isLoading ? (
				...
				<div className="flex items-center justify-center py-8">
					<div className="text-zinc-400">No artist applications found</div>
				</div>
			) : (
										...
										<div className="flex gap-2 justify-end">
											...
											{app.verificationStatus === "approved" && (
												<Button
													...
													title="Delete artist (remove artist status and verification)"
												>
