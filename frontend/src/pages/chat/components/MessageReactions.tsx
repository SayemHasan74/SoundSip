	...
	return (
		<div className="flex items-center gap-1 flex-wrap mt-1">
			...
			<div className="relative">
				...
				{/* Quick emoji picker */}
				{showEmojiPicker && (
					<div className="absolute bottom-full left-0 mb-1 bg-zinc-800 border border-zinc-600 rounded-lg p-2 shadow-lg z-20">
						<div className="flex gap-1">
							{commonEmojis.map((emoji) => (
								<Button
									...
									className="h-8 w-8 p-0 hover:bg-zinc-700 rounded-md"
