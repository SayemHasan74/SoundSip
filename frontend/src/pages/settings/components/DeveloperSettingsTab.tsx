			...
			<Card>
				...
				<CardContent className="space-y-4">
					<div className="space-y-4">
						...
						<div className="flex items-center justify-between">
							<div className="space-y-0.5">
								<Label htmlFor="spotify-sync">External Sync</Label>
								<p className="text-sm text-muted-foreground">
									Synchronize playlists and favorites with external services
								</p>
							</div>
							<Switch
								id="spotify-sync"
								checked={settings.advanced.integration.spotifySync}
								onCheckedChange={(checked) => handleIntegrationChange("spotifySync", checked)}
							/>
						</div>
