...
const PlatformSettingsTab: React.FC = () => {
	...
	const handlePlatformChange = (platform: keyof typeof settings.platforms, type: keyof typeof settings.platforms.spotify, value: boolean) => {
	...
	const platforms = [
		{
			id: "spotify",
			name: "External Music Service",
			description: "Connect your music account to sync playlists and favorites",
			icon: "🎵",
			color: "bg-green-500",
			available: true,
